...
my_file.write("\n")
my_file.write("------------------------------\n")
print(f'{candidate_no[2]}: {percentage_change_voter_3:.3%} ({vote3})',file=my_file)
my_file.write("\n")
print(f'{candidate_no[3]}: {percentage_change_voter_4:.3%} ({vote4})',file=my_file)
my_file.write("\n")
print(f'{candidate_no[1]}: {percentage_change_voter_2:.3%} ({vote2})',file=my_file)
my_file.write("\n")
print(f'{candidate_no[0]}: {percentage_change_voter_1:.3%} ({vote1})',file=my_file)
my_file.write("\n")
my_file.write("------------------------------")
my_file.write("\n")
print(f'Winner:{winner_candidate}',file=my_file)
my_file.close()
